  ...
  describe("changeOwner()", () => {
    describe("using msg.sender", () => {
      describe("as current owner", () => {
        ...
        it("should create geoDIDDelegateChanged event", () => {
          const event = tx.logs[0];
          assert.equal(event.event, "geoDIDOwnerChanged");
      ...
      describe("as new owner", () => {
        ...
        it("should create geoDIDOwnerChanged event", () => {
          const event = tx.logs[0];
          assert.equal(event.event, "geoDIDOwnerChanged");
          assert.equal(event.args.identity, identity);
  ...
  describe("addDelegate()", () => {
    describe("using msg.sender", () => {
      ...
      describe("as current owner", () => {
        ...
        it("should create geoDIDDelegateChanged event", () => {
          const event = tx.logs[0];
          assert.equal(event.event, "geoDIDDelegateChanged");
          assert.equal(event.args.identity, identity);
  ...
  describe("setAttribute()", () => {
    describe("using msg.sender", () => {
      describe("as current owner", () => {
        ...
        it("should create geoDIDAttributeChanged event", () => {
          const event = tx.logs[0];
          assert.equal(event.event, "geoDIDAttributeChanged");
          assert.equal(event.args.identity, identity);
  ...
  describe("Events", () => {
    it("can create list", async () => {
      ...
      assert.deepEqual(history, [
        "geoDIDOwnerChanged",
        "geoDIDOwnerChanged",
        "geoDIDDelegateChanged",
        "geoDIDDelegateChanged",
        "geoDIDAttributeChanged",
        "geoDIDAttributeChanged",
      ]);
    });
  });
